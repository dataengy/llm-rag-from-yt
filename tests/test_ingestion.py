...
from llm_rag_yt.ingestion.automated_pipeline import AutomatedIngestionPipeline, IngestionJob
...
class TestAutomatedIngestionPipeline:
    ...
    def test_pipeline_stats(self, mock_rag_pipeline, temp_config):
        ...
        # Mock vector store
        mock_rag_pipeline.return_value.vector_store.get_collection_info.return_value = {"count": 100}
    ...
    def test_job_execution_failure(self, mock_rag_pipeline, temp_config):
        ...
        mock_pipeline_instance = mock_rag_pipeline.return_value
        mock_pipeline_instance.download_and_process.side_effect = Exception("Test error")
