...
class TelegramDatabase:
    ...
    def log_youtube_request(
        self, user_id: int, url: str, status: str, metadata: Optional[dict] = None
    ):
    ...
    def update_youtube_request_status(
        self, request_id: int, status: str, error_message: Optional[str] = None
    ):
